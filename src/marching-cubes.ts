  ...
  for (let z = 0; z < data.depth; z += 1) {
    for (let y = 0; y < data.height; y += 1) {
      for (let x = 0; x < data.width; x += 1) {
        ...
        const e0 = data.src[dataindex];
        const e1 = data.src[dataindex + dx];
        const e2 = data.src[dataindex + dx + dz];
        const e3 = data.src[dataindex + dz];
        const e4 = data.src[dataindex + dy];
        const e5 = data.src[dataindex + dx + dy];
        const e6 = data.src[dataindex + dx + dy + dz];
        const e7 = data.src[dataindex + dy + dz];
        let cubeindex = 0;
        if (e0 < isolevel) cubeindex += 1;
        if (e1 < isolevel) cubeindex += 2;
        if (e2 < isolevel) cubeindex += 4;
        if (e3 < isolevel) cubeindex += 8;
        if (e4 < isolevel) cubeindex += 16;
        if (e5 < isolevel) cubeindex += 32;
        if (e6 < isolevel) cubeindex += 64;
...
export default runMarchingCubes;
